...
namespace DMFX.NewsAnalysis.Functions.Common
{
    public class FunctionHelper
    {
        ...
        public void SetCreatedModifiedProperties(object obj, string propNameDate, string propNameID, DMFX.NewsAnalysis.Interfaces.Entities.User currentUser = null)
        {
        ...
        public ObjectResult CreateResult(HttpStatusCode code, object resultDto = null, string errorMessage = null)
        {
            ...
            {
                result = new ObjectResult(ToJosn(new DMFX.NewsAnalysis.DTO.Error()
                {
                    Code = (int)code,
